...
// //         {/* Action Buttons Moved Here (Above Tabs) */}
...
// //           {/* Total People inline with the Active Tab Header */}
...
// //               <input className="border p-2 rounded bg-white" placeholder="Mode of Transportation" value={newGuest.transportion} onChange={e => setNewGuest({...newGuest, transportion: e.target.value})} />
...
// //                 <tr key={g.id} className={`border-b hover:bg-slate-50 ${g.arrived ? "line-through text-slate-400 bg-green-50" : ""}`}>
// //                   {editingId === g.id ? (
// //                     <>
...
//         {/* Action Buttons: Stacked vertically on mobile, side-by-side on sm+ */}
...
//           <table className="w-full text-sm">
//             <thead>
//               <tr className="text-slate-700 border-b text-left whitespace-nowrap">
//                 <th className="p-3">Sr No</th>
//                 {activeTab.includes("Staying") && <th className="p-3">Room</th>}
//                 {activeTab.includes("Staying") && <th className="p-3 text-center">Arrived</th>}
//                 <th className="p-3">Family Name</th>
