      ...
      <div className="border rounded-lg p-6 bg-white shadow-sm">
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="bg-emerald-50 text-emerald-700 px-4 py-1 rounded-full font-medium">
...
//     TABS.forEach((tab) => {
//       const tabGuests = dbGuests.filter((g) => g.tab_category === tab.name);

//       const sheetData = tabGuests.map((g, index) => ({
//         "Sr No": index + 1,
//         "Room No": g.room_no || "-",
//         "Arrived": g.arrived ? "Yes" : "No",
//         "Family Name": g.family,
