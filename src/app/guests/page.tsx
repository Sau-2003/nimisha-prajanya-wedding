...
// // // // //     room: "", mobile: "", arrivalTime: "", departureTime: "", family: "", count: "", hotel: "", arrival: "", departure: "", origin: "", transportionArrival: "", transportionDeparture: ""
// // // // //   });
...
// // // // //       alert("Please fill in both Name and No. of People.");
// // // // //       return;
// // // // //     }
...
// // // // //       departure_time: category === activeTab ? (newGuest.departureTime || null) : null,
// // // // //       hotel_name: category === activeTab ? newGuest.hotel : "",
// // // // //       arrival_date: category === activeTab ? (newGuest.arrival || null) : null,
// // // // //       departure_date: category === activeTab ? (newGuest.departure || null) : null,
// // // // //       transportaion_name: category === activeTab ? newGuest.transportionArrival : "",
// // // // //       transportation_departure: category === activeTab ? newGuest.transportionDeparture : "",
...
// // // // //     setNewGuest({ room: "", family: "", count: "", mobile: "", arrivalTime: "", departureTime: "", hotel: "", arrival: "", departure: "", origin: "", transportionArrival: "", transportionDeparture: "" });
// // // // //     fetchData();
// // // // //   };
...
// // // // //         {/* Input Form matching requested sequence */}
// // // // //         <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 mb-6 bg-slate-50 p-4 rounded-lg">
// // // // //           <input className="border p-2 rounded bg-white w-full" placeholder="Name" value={newGuest.family} onChange={e => setNewGuest({...newGuest, family: e.target.value})} />
...
// // // // //               <input className="border p-2 rounded bg-white w-full" placeholder="Mode of Transportation (Arrival)" value={newGuest.transportionArrival} onChange={e => setNewGuest({...newGuest, transportionArrival: e.target.value})} />
...
// // // // //                 value={newGuest.departure} 
// // // // //                 onChange={e => setNewGuest({...newGuest, departure: e.target.value})} 
// // // // //               />
...
// // // // //                 value={newGuest.departureTime} 
// // // // //                 onChange={e => setNewGuest({...newGuest, departureTime: e.target.value})} 
// // // // //               />

// // // // //               <input className="border p-2 rounded bg-white w-full" placeholder="Mode of Transportation (Departure)" value={newGuest.transportionDeparture} onChange={e => setNewGuest({...newGuest, transportionDeparture: e.target.value})} />
// // // // //             </>
// // // // //           )}
...
// // // // //         {/* Table matching exact order requested */}
...
// // // // //                 <tr key={g.id} className={`border-b hover:bg-slate-50 ${g.arrived ? "text-emerald-800 bg-green-50 font-medium" : ""}`}>
// // // // //                   {editingId === g.id ? (
// // // // //                     <>
...
// // // //             <tbody>
// // // //               {filteredGuests.map((g, idx) => (
// // // //                 <tr key={g.id} className={`border-b hover:bg-slate-50 ${g.arrived ? "text-slate-600 line-through bg-green-50 font-medium" : ""}`}>
// // // //                   {editingId === g.id ? (
// // // //                     <>
// // // //                       <td className="p-3 text-slate-500">{idx + 1}</td>
// // // //                       {activeTab.includes("Staying") && (
...
//   // Automatically add/remove guest from Sangeet, Haldi, or Reception
...
//     } else {
//       // Copy them to the new event tab
...
//     }
//     fetchData(); // Refresh the data to update the checkmarks
//   };
