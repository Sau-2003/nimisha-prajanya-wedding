...
export default function DateSchedulePage() {
  ...
  const fetchData = async () => {
    ...
    // Sort: Tasks with NO due date come FIRST (-1), then chronological order
    const sorted = combined.sort((a, b) => {
      if (!a.due_date && !b.due_date) return 0;
      if (!a.due_date) return -1; // Put nulls at the top
      if (!b.due_date) return 1;  // Put nulls at the top
    ...
    <div className="p-6 md:p-12 max-w-4xl mx-auto">
      ...
      <div className="space-y-6">
        {Object.entries(
          ...
          const isUnscheduled = date === "Unscheduled Tasks";
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {item.due_date ? (
                          ...
                          <p className="text-xs text-slate-400 mt-1 italic">No due date set</p>
                        )}
