...
//       dueDate: newItemDate || undefined, // MUST be null, not undefined
//       imageUrl: newItemImage || undefined, // MUST be null, not undefined
...
//         // Aggressive scale down to ensure it fits in database limits
//         const MAX_SIZE = 500; 
//         let width = img.width;
...
//                               onError={(e) => {
//                                 // Hide the broken image wrapper if the URL fails to load
