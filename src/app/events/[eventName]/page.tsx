    ...
    <div className="min-h-screen p-6 md:p-12 max-w-6xl mx-auto">
      ...
      <Dialog open={!!activeModal} onOpenChange={(open) => !open && setActiveModal(null)}>
        <DialogContent className="sm:max-w-xl">
          <button type="button" autoFocus className="absolute opacity-0 w-0 h-0 pointer-events-none" aria-hidden="true" />
          <DialogHeader>
                ...
                {editingItemId === item.id ? (
                  <div className="flex-1 flex flex-col gap-2 w-full">
                    <textarea 
                      ...
                      className="border border-emerald-500 rounded-md outline-none px-2 py-2 text-slate-700 text-sm w-full resize-none" 
                      rows={3}
                    />
