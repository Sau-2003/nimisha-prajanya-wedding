...
// // // //   // Safely sort Note ensuring pinned items are on top
// // // //   useEffect(() => {
// // // //     if (notes) {
...
// // // //     // 2. Insert into Supabase and request the newly created row back
...
// // // //     // 3. Instantly add the new note to the UI and apply correct sorting
// // // //     if (data) {
// // // //       setLocalNote(prev => {
...
// // // //     // 4. Scroll to the TOP of the page where the new note just appeared
// // // //     window.scrollTo({ top: 0, behavior: 'smooth' });

// // // //     // 5. Sync in the background just to be safe
// // // //     fetchData(); 
// // // //   };
...
// // // //   if (loading) return <div className="p-12 text-center text-emerald-600 font-bold">Loading Note...</div>;
...
// // // //         {localNote.length === 0 ? (
// // // //            <div className="text-center py-12 text-slate-400 italic">No Note tracked yet. Click "Add Note Ideas" to get started!</div>
// // // //         ) : (
...
// // // }) {
// // //   const grid = (tableData && tableData.length > 0) 
// // //     ? tableData 
// // //     : [["Item", "Details", "Amount"], ["", "", ""]];
...
// // //   // Toggle state to show/hide the spreadsheet table
// // //   const [showTable, setShowTable] = useState(
// // //     Boolean(gift.table_data && gift.table_data.length > 0)
// // //   );
...
// // //         {/* --- TOGGLE SPREADSHEET BUTTON & TABLE --- */}
// // //         {showTable ? (
// // //           <div>
// // //             <ExcelTableEditor
...
//   onChange: (newData: string[][]) => void; 
// }) {
//   // Safely parse and validate tableData to ensure it's always a valid 2D array
//   let grid: string[][] = [["Item", "Details", "Amount"], ["", "", ""]];
...
//   // Toggle state to show/hide the spreadsheet table safely
//   const [showTable, setShowTable] = useState(
