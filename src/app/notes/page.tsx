        ...
        {notes.map((note, idx) => (
          <div key={note.id} className="relative bg-white w-full rounded-xl shadow-md border border-slate-100 overflow-hidden group">
            <button 
              ...
              className="absolute top-6 right-6 p-2 text-slate-300 hover:text-red-500 hover:bg-red-50 rounded-lg opacity-0 group-hover:opacity-100 z-10"
            >
            ...
            <div className="pt-8 pb-4 pl-12 md:pl-16 pr-8">
              <input 
                className="text-5xl font-sans text-[#c4b5fd] tracking-widest uppercase w-full bg-transparent focus:outline-none"
                value={note.title}
                onChange={(e) => {
