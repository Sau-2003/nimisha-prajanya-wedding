...
// // // //   // --- NEW HANDLER FOR CREATING A NOTE WITH A PRE-FILLED SPREADSHEET ---
...
// // //         {/* Toolbar: Add Images ONLY (Add Spreadsheet button removed from here) */}
// // //         <div className="pt-2 flex flex-wrap items-center gap-2">
// // //           <input
// // //             type="file"
// // //             accept="image/*"
...
// //             type="button"
// //             onClick={() => setIsEditing(true)}
// //             className="flex items-center justify-center w-full gap-2 p-3 text-sm font-medium transition-colors border-2 border-dashed rounded-lg text-slate-400 border-slate-200 hover:border-emerald-300 hover:bg-emerald-50 hover:text-emerald-700"
// //           >
// //             <Plus className="w-4 h-4" /> Add Description / Links
// //           </button>
// //         )}
...
//           />
//         ) : showTable && !content ? (
//           // ONLY show dashed button on active Spreadsheet notes when content is empty
//           <button
//             type="button"
//             onClick={() => setIsEditing(true)}
//             className="flex items-center justify-center w-full gap-2 p-3 text-sm font-medium transition-colors border-2 border-dashed rounded-lg text-slate-400 border-slate-200 hover:border-emerald-300 hover:bg-emerald-50 hover:text-emerald-700"
...
//           </button>
//         ) : (
//           // Standard view for normal notes (or spreadsheet notes that already have content)
//           <div
//             onClick={() => setIsEditing(true)}
//             className="border border-transparent hover:border-slate-200 rounded-lg p-2 whitespace-pre-wrap break-words cursor-text min-h-[50px] transition-colors text-slate-600 text-sm"
//           >
