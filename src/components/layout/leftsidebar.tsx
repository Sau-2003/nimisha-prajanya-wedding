...
//               className="text-xs bg-slate-50 border border-slate-200 rounded-md py-1 px-2 focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 text-slate-600 cursor-pointer"
//             >
